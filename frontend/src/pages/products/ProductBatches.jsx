    ...
    <MainLayout>
      <div className="card">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between mb-3">
          <strong className="ct" style={{ fontSize: 15, flexShrink: 0 }}>Batches</strong>
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <Button variant="primary" size="sm" onClick={openCreate}><Plus size={13} strokeWidth={2.5} /><span>Add Batch</span></Button>
          </div>
        </div>
          ...
          <table className="w-full">
            ...
            <tbody>
              {loading ? (
                ...
                <tr><td colSpan={7} style={{ textAlign: "center", color: "var(--tx3)", padding: "24px 0" }}>No batches found</td></tr>
              ) : paged.map(r => {
